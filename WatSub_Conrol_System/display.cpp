...
//argument 5 of draw curve is 0, 1,2,3 
  ...
  tft.drawRect(BATTERY_TOP_LEFT_X + 21, BATTERY_TOP_LEFT_Y + 1, BATTERY_WIDTH, BATTERY_HEIGTH, RA8875_RED);
  tft.drawRect(BATTERY_TOP_LEFT_X + 22, BATTERY_TOP_LEFT_Y + 2, BATTERY_WIDTH, BATTERY_HEIGTH, RA8875_RED);
  tft.drawRect(BATTERY_TOP_LEFT_X + 23, BATTERY_TOP_LEFT_Y + 3, BATTERY_WIDTH, BATTERY_HEIGTH, RA8875_RED);
  tft.drawRect(BATTERY_TOP_LEFT_X + 24, BATTERY_TOP_LEFT_Y + 4, BATTERY_WIDTH, BATTERY_HEIGTH, RA8875_RED);
...
void Display::battery_life(int battery_left){
  if(battery_left != battery_displayed){
    tft.fillRect(BATTERY_TOP_LEFT_X + round(BATTERY_WIDTH *(1 - battery_left/100.0)) + 8, BATTERY_TOP_LEFT_Y +8,
                 round(BATTERY_WIDTH * battery_left/100) , BATTERY_HEIGTH -16, RA8875_RED);
  }
}
